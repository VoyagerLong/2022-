...
# 读取 De-trend_p
Asmooth_2 = np.genfromtxt("./16_upperbound.txt",delimiter = ",")
...
************************************************************
'''
signal = np.genfromtxt("./16_top.txt",delimiter = ",")
...
plt.plot(s_dist_along, s_height, 'bo', label='初步估计的 ground 光子')
plt.plot(d_dist_along, d_height, 'r', label='上边界')
plt.legend()

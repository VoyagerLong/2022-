...
# 读取 De-trend_p
Asmooth_2 = np.genfromtxt("./15_potential_ground.txt",delimiter = ",")
...
************************************************************
'''
signal = np.genfromtxt("./14_lowerbound.txt",delimiter = ",")
...
plt.plot(d_dist_along, d_height, 'ro', label='可能的 ground 光子')
plt.legend()


plt.savefig('potential_ground_photons.png')